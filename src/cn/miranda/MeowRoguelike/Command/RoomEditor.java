...
public class RoomEditor implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        ArrayList<String> validArgs = new ArrayList<>(Arrays.asList("select", "save", "load", "list", "remove"));
        ...
        if (Objects.equals(option, "load") && args.length == 2) {
            ...
            plugin.sessions.get(player).getRoom().showRoom(player.getLocation());
    ...
    public List<String> onTabComplete(CommandSender commandSender, Command command, String s, String[] strings) {
        if (strings.length == 1) {
            return Misc.returnSelectList(new ArrayList<>(Arrays.asList("select", "save", "load", "list", "remove")), strings[0]);
        }
        return null;
    }
}
